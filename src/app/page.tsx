      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900 bg-fixed bg-cover' style={{backgroundImage: `url(${bgImg.src})`}}>
        <section className='min-h-screen'>
          ...
          <div className='text-center p-10'>
            ...
            <p  className='text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto dark:text-white'>Mobile and Web Developer enthusiats with a passion for creating beautiful applications to help solve real world problems</p>
          </div>
